...
-- CreateEnum
CREATE TYPE "public"."role" AS ENUM ('SCHOLAR', 'FINANCE', 'ACADEMIC', 'SPC', 'TUTOR', 'ADMIN');

-- CreateEnum
CREATE TYPE "public"."bank_account_type" AS ENUM ('SAVINGS', 'CURRENT');

-- CreateEnum
CREATE TYPE "public"."scholar_state" AS ENUM ('ACTIVE', 'INACTIVE', 'GRADUATED');
...
-- CreateTable
CREATE TABLE "public"."scholar_addresses" (
    "id" SERIAL NOT NULL,
    "scholar_id" UUID NOT NULL,
    "address_id" INTEGER NOT NULL,
    ...
    CONSTRAINT "scholar_addresses_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "public"."scholar_phone_numbers" (
    "id" SERIAL NOT NULL,
    "scholar_id" UUID NOT NULL,
    ...
    CONSTRAINT "scholar_phone_numbers_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "public"."scholars" (
    ...
    "ingress_date" TIMESTAMPTZ(6),
    "egress_date" TIMESTAMPTZ(6),
    "egress_comments" TEXT,
    "emergency_contact_name" TEXT,
    "emergency_contact_phone" TEXT,
    "emergency_contact_relationship" TEXT,
    "dui" TEXT,
    "state" "public"."scholar_state" NOT NULL,
    "created_at" TIMESTAMPTZ(6) NOT NULL,
    "created_by" UUID NOT NULL,
...
-- CreateTable
CREATE TABLE "public"."scholars_logbook" (
    "id" SERIAL NOT NULL,
    "scholar_id" UUID NOT NULL,
    "date" TIMESTAMPTZ(6),
    "log" VARCHAR(2000),
    ...
    CONSTRAINT "scholars_logbook_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "idx_addresses_municipality_id" ON "public"."addresses"("municipality_id");
...
-- CreateIndex
CREATE INDEX "idx_bank_accounts_scholar_id" ON "public"."bank_accounts"("scholar_id");
...
-- CreateIndex
CREATE INDEX "idx_residences_address_id" ON "public"."residences"("address_id");

-- CreateIndex
CREATE INDEX "idx_residences_name" ON "public"."residences"("name");

-- CreateIndex
CREATE INDEX "idx_residences_phone" ON "public"."residences"("phone");

-- CreateIndex
CREATE INDEX "idx_scholar_addresses_address_id" ON "public"."scholar_addresses"("address_id");

-- CreateIndex
CREATE INDEX "idx_scholar_addresses_created_at" ON "public"."scholar_addresses"("created_at");

-- CreateIndex
CREATE INDEX "idx_scholar_addresses_is_current" ON "public"."scholar_addresses"("is_current");

-- CreateIndex
CREATE INDEX "idx_scholar_addresses_scholar_id" ON "public"."scholar_addresses"("scholar_id");

-- CreateIndex
CREATE INDEX "idx_scholar_phone_numbers_is_current" ON "public"."scholar_phone_numbers"("is_current");

-- CreateIndex
CREATE INDEX "idx_scholar_phone_numbers_is_mobile" ON "public"."scholar_phone_numbers"("is_mobile");

-- CreateIndex
CREATE INDEX "idx_scholar_phone_numbers_phone_number_id" ON "public"."scholar_phone_numbers"("phone_number_id");

-- CreateIndex
CREATE INDEX "idx_scholar_phone_numbers_scholar_id" ON "public"."scholar_phone_numbers"("scholar_id");

-- CreateIndex
CREATE INDEX "idx_scholars_created_at" ON "public"."scholars"("created_at");

-- CreateIndex
CREATE INDEX "idx_scholars_created_by" ON "public"."scholars"("created_by");

-- CreateIndex
CREATE INDEX "idx_scholars_dob" ON "public"."scholars"("dob");

-- CreateIndex
CREATE INDEX "idx_scholars_egress_date" ON "public"."scholars"("egress_date");

-- CreateIndex
CREATE INDEX "idx_scholars_ingress_date" ON "public"."scholars"("ingress_date");

-- CreateIndex
CREATE INDEX "idx_scholars_state" ON "public"."scholars"("state");

-- CreateIndex
CREATE INDEX "idx_scholars_user_id" ON "public"."scholars"("user_id");

-- CreateIndex
CREATE INDEX "idx_scholars_logbook_created_at" ON "public"."scholars_logbook"("created_at");

-- CreateIndex
CREATE INDEX "idx_scholars_logbook_created_by" ON "public"."scholars_logbook"("created_by");

-- CreateIndex
CREATE INDEX "idx_scholars_logbook_date" ON "public"."scholars_logbook"("date");

-- CreateIndex
CREATE INDEX "idx_scholars_logbook_scholar_id" ON "public"."scholars_logbook"("scholar_id");
...
-- AddForeignKey
ALTER TABLE "public"."addresses" ADD CONSTRAINT "addresses_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."addresses" ADD CONSTRAINT "addresses_municipality_id_fkey" FOREIGN KEY ("municipality_id") REFERENCES "public"."municipalities"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."bank_accounts" ADD CONSTRAINT "bank_accounts_bank_id_fkey" FOREIGN KEY ("bank_id") REFERENCES "public"."banks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."bank_accounts" ADD CONSTRAINT "bank_accounts_scholar_id_fkey" FOREIGN KEY ("scholar_id") REFERENCES "public"."scholars"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."municipalities" ADD CONSTRAINT "municipalities_department_id_fkey" FOREIGN KEY ("department_id") REFERENCES "public"."departments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."residences" ADD CONSTRAINT "residences_address_id_fkey" FOREIGN KEY ("address_id") REFERENCES "public"."addresses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."residences" ADD CONSTRAINT "residences_phone_fkey" FOREIGN KEY ("phone") REFERENCES "public"."phone_numbers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."scholar_addresses" ADD CONSTRAINT "scholar_addresses_address_id_fkey" FOREIGN KEY ("address_id") REFERENCES "public"."addresses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."scholar_addresses" ADD CONSTRAINT "scholar_addresses_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."scholar_addresses" ADD CONSTRAINT "scholar_addresses_scholar_id_fkey" FOREIGN KEY ("scholar_id") REFERENCES "public"."scholars"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."scholar_phone_numbers" ADD CONSTRAINT "scholar_phone_numbers_phone_number_id_fkey" FOREIGN KEY ("phone_number_id") REFERENCES "public"."phone_numbers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."scholar_phone_numbers" ADD CONSTRAINT "scholar_phone_numbers_scholar_id_fkey" FOREIGN KEY ("scholar_id") REFERENCES "public"."scholars"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."scholars" ADD CONSTRAINT "scholars_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."scholars" ADD CONSTRAINT "scholars_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."scholars_logbook" ADD CONSTRAINT "scholars_logbook_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."scholars_logbook" ADD CONSTRAINT "scholars_logbook_scholar_id_fkey" FOREIGN KEY ("scholar_id") REFERENCES "public"."scholars"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
